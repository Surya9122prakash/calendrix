...
A powerful, framework-agnostic, and highly customizable React calendar component library. Built with performance and elegance in mind, `calendrix` provides a premium scheduling experience out of the box.
...
`calendrix` comes packed with 10 predefined calendar themes and 10 conflict alert templates.
...
When events overlap, `calendrix` can display a modal using these templates:
...
MIT © [calendrix](https://github.com/Surya9122prakash/calendrix)
