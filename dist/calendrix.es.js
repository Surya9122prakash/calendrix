...
const mt = ({ onChange: t, timeFormat: d, slotInterval: l, timezone: o, enabledTimeSlots: n, disabledTimeSlots: k, enabledTimeInterval: u, disableTimeInterval: i, checkIsSlotEnabled: m }) => {
  ...
  return t ? /* @__PURE__ */ a("div", { className: "fixed inset-0 bg-gray-900/60 flex items-center justify-center z-50 backdrop-blur-sm animate-fadeIn", children: [
    /* @__PURE__ */ a("div", { className: "bg-white rounded-2xl p-8 w-[450px] shadow-2xl border border-gray-100 max-h-[90vh] overflow-y-auto transform animate-scaleIn", children: [
      ...
      k?.map((r) => /* @__PURE__ */ a("div", { className: "mb-[16px]", children: [
        /* @__PURE__ */ e("label", { className: "block text-sm mb-[4px]", children: r.label }),
        (() => {
          switch (r.type) {
            case "textarea":
              return /* @__PURE__ */ e("textarea", { required: r.required, value: o[r.name] || "", onChange: (s) => n({ ...o, [r.name]: s.target.value }), className: "w-full border border-[#e5e7eb] rounded-lg p-[20px] focus:ring-2 focus:ring-[#3b82f6] focus:border-[#3b82f6] outline-none transition-all text-[#374151] bg-[#f9fafb80]", rows: 3 });
            case "dropdown":
            case "singleSelect":
              return /* @__PURE__ */ a("select", { required: r.required, value: o[r.name] || "", onChange: (s) => n({ ...o, [r.name]: s.target.value }), className: "w-full border border-[#e5e7eb] rounded-lg p-[20px] focus:ring-2 focus:ring-[#3b82f6] focus:border-[#3b82f6] outline-none transition-all text-[#374151] bg-[#f9fafb80]", children: [
            ...
            case "multiselect":
              return /* @__PURE__ */ e("select", { multiple: !0, required: r.required, value: o[r.name] || [], onChange: (s) => {
                ...
                n({ ...o, [r.name]: E });
              }, className: "w-full border border-[#e5e7eb] rounded-lg p-[20px] focus:ring-2 focus:ring-[#3b82f6] focus:border-[#3b82f6] outline-none transition-all text-[#374151] bg-[#f9fafb80] h-[128px]", children: r.options?.map((s) => /* @__PURE__ */ e("option", { value: s.value, children: s.label }, s.value)) });
            case "radio":
            ...
            case "year":
              return /* @__PURE__ */ e("input", { type: "number", required: r.required, placeholder: "YYYY", value: o[r.name] || "", onChange: (s) => n({ ...o, [r.name]: s.target.value }), className: "w-full border border-[#e5e7eb] rounded-lg p-[20px] focus:ring-2 focus:ring-[#3b82f6] focus:border-[#3b82f6] outline-none transition-all text-[#374151] bg-[#f9fafb80]" });
            case "day":
              return /* @__PURE__ */ e("input", { type: "number", required: r.required, min: "1", max: "31", placeholder: "DD", value: o[r.name] || "", onChange: (s) => n({ ...o, [r.name]: s.target.value }), className: "w-full border border-[#e5e7eb] rounded-lg p-[20px] focus:ring-2 focus:ring-[#3b82f6] focus:border-[#3b82f6] outline-none transition-all text-[#374151] bg-[#f9fafb80]" });
            default:
              ...
              return /* @__PURE__ */ a("div", { className: "relative", children: [
                /* @__PURE__ */ e(
                  "input",
                  {
                    ...
                    className: `w-full border border-[#e5e7eb] rounded-lg p-[20px] focus:ring-2 focus:ring-[#3b82f6] focus:border-[#3b82f6] outline-none transition-all text-[#374151] bg-[#f9fafb80] cursor-pointer ${w ? "pr-[48px]" : ""}`,
                    readOnly: w
                  }
                ),
                w && /* @__PURE__ */ e(
