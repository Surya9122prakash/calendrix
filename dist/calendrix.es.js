              ...
              return /* @__PURE__ */ a("div", { className: "relative", children: [
                /* @__PURE__ */ e(
                  "input",
                  {
                    ...
                    className: `w-full border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-gray-700 bg-gray-50/50 cursor-pointer ${Y ? "pr-12" : ""}`,
                    readOnly: Y
                  }
                ),
                Y && /* @__PURE__ */ e(
